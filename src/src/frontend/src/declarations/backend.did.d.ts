...
export interface AssistantResponse { 'content' : string, 'timestamp' : Time }
...
export interface _SERVICE {
  ...
  'getAllMessages' : ActorMethod<[], Array<ConversationEntry>>,
  'getMessage' : ActorMethod<[bigint], ConversationEntry>,
